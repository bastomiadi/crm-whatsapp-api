...
@section('title', 'Send Message - Contact')
...
<div class="space-y-6">
    ...
    <div class="flex items-center justify-between">
        <div>
            ...
            <p class="text-gray-500 mt-1">Send message to contact</p>
        </div>
        <a href="{{ route('crm.contacts.index') }}" class="px-4 py-2 bg-gray-200 text-gray-700 rounded-lg hover:bg-gray-300 transition-colors">
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div class="lg:col-span-2 bg-white rounded-xl shadow-sm">
            ...
            <form id="messageForm" class="p-6 space-y-4">
                ...
                <!-- Recipient (Hidden - pre-filled from contact) -->
                <input type="hidden" name="chatId" value="{{ $contact->phone ?? '' }}">
                <input type="hidden" name="contactId" value="{{ $contact->id ?? '' }}">
                
                <!-- Recipient Display -->
                <div class="bg-gray-50 rounded-lg p-3">
                    <p class="text-sm text-gray-500">Recipient</p>
                    <p class="font-medium text-gray-800">{{ $contact->phone ?? 'Not available' }}</p>
                </div>
